package dev.aman.jobportalauthservice.Security.Services;

import java.util.HashSet;
import java.util.Set;


import dev.aman.jobportalauthservice.Security.Models.AuthorizationConsent;
import dev.aman.jobportalauthservice.Security.Repositories.AuthorizationConsentRepository;
